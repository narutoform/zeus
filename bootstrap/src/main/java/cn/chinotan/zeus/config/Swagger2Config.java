...
import cn.chinotan.zeus.config.properties.SwaggerProperties;
import cn.chinotan.zeus.framework.common.exception.ZeusConfigException;
...
public class Swagger2Config {
    ...
    public String[] getBasePackages() {
        ...
        if (StringUtils.isBlank(basePackage)) {
            throw new ZeusConfigException("Swagger basePackage不能为空");
        }
