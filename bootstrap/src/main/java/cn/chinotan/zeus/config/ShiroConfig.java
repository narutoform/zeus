...
import cn.chinotan.zeus.config.properties.ShiroPermissionProperties;
import cn.chinotan.zeus.config.properties.ShiroProperties;
import com.alibaba.fastjson.JSON;
import cn.chinotan.zeus.config.properties.JwtProperties;
import cn.chinotan.zeus.framework.shiro.cache.LoginRedisService;
import cn.chinotan.zeus.framework.shiro.exception.ShiroConfigException;
import cn.chinotan.zeus.framework.shiro.jwt.JwtCredentialsMatcher;
import cn.chinotan.zeus.framework.shiro.jwt.JwtFilter;
import cn.chinotan.zeus.framework.shiro.jwt.JwtRealm;
import cn.chinotan.zeus.framework.shiro.service.ShiroLoginService;
...
@ConditionalOnProperty(value = {"zeus.shiro.enable"}, matchIfMissing = true)
