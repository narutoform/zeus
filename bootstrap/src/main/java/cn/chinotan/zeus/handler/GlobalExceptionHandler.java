package cn.chinotan.zeus.handler;
...
import cn.chinotan.zeus.system.exception.SysLoginException;
import cn.chinotan.zeus.system.exception.VerificationCodeException;
...
public class GlobalExceptionHandler {
    ...
    @ResponseStatus(HttpStatus.OK)
    public ApiResult<Boolean> zeusExceptionHandler(ZeusException exception) {
        printRequestDetail();
        log.error("zeusException:", exception);
        int errorCode;
        if (exception instanceof BusinessException) {
            ...
            errorCode = ApiCode.zeus_EXCEPTION.getCode();
        }
    ...
    public ApiResult<String> httpRequestMethodNotSupportedExceptionHandler(Exception exception) {
        ...
        return ApiResult.fail(ApiCode.HTTP_REQUEST_METHOD_NOT_SUPPORTED_EXCEPTION, exception.getMessage());
    }
